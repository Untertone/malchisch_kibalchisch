...
***Fox Hole*** demo with interactive desktop and [VR](../...md) ([HTC Vive/Vive PRO/OpenVR](../...md) by default) modes is designed to showcase capabilities of the engine for real-time architectural visualization and BIM (Building Information Model) applications.
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/demos\foxhole_2.21*
...
1. Find the **Fox Hole Demo** demo in the *Demos* section and click **[Install](/sdk/#samples)** (if you haven't installed it yet).
