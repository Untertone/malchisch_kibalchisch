...
- Over **1,300** [light sources](../../objects/lights/index.md)
...
1. Find the **Oil Refinery Demo** demo in the *Demos* section and click **[Install](/sdk/#samples)** (if you haven't installed it yet).
