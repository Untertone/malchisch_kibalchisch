...
*Superposition* presents top-notch visuals powered by UNIGINE 2 Engine and the unique SSRTGI technique, developed by UNIGINE. Being a non-synthetic benchmark, *Superposition* supports an interactive mode with more than 900 objects and [VR mode](../...md) compatible with the most popular VR peripherals.
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/demos\superposition_2.21*
...
1. Find the **Superposition** demo in the *Demos* section and click **[Install](/sdk/#samples)** (if you haven't installed it yet).
