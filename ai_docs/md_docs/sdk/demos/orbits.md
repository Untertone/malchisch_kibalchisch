...
Visualization of satellite trajectories around the planet.
...
**SDK Path:***<SAMPLES_PROJECT_PATH>/demos\orbits_2.21*
...
1. Find the **Orbits Demo** demo in the *Demos* section and click **[Install](/sdk/#samples)** (if you haven't installed it yet).
