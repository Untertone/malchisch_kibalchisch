...
What each object can do is defined by the properties attached to it. For example, geometric primitives have the [ObjMovable](../../...md) property (grab, hold, throw), while the laser pointer also has [ObjLaserPointer](../../...md) (emits a beam when activated).
...
Built with: [ObjMovable](../../...md), [ObjLaserPointer](../../...md)
