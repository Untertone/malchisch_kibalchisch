...
The latest platform-specific version of UNIGINE SDK can be downloaded at the [UNIGINE developer portal](https://developer.unigine.com) in the [Downloads](https://developer.unigine.com/downloads) section.


> **Notice:** A 64-bit Operating System is required to develop applications using UNIGINE 2 SDK.


Read the following articles to know how to prepare the development environment of different platforms:


- [Windows](../../code/environment/windows.md)
- [Linux](../../code/environment/linux.md)
