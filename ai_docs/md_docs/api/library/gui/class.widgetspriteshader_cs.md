# Unigine::WidgetSpriteShader Class (CS)
...
The post-process material for the widget.
### Members
...
- *[Gui](../../../api/library/gui/class.gui_cs.md)* **gui** - [GUI](../../../api/library/gui/class.gui_cs.md), to which the sprite will belong.
- *string* **name** - Path to the texture. This is an optional parameter.

## WidgetSpriteShader ( string name = 0 )
