# Unigine::AnimationModifierVec2 Class (USC)
...
## AnimationModifierVec2 ( int param )
...
## AnimationModifierVec2 ( int param , int param_index )
...
## AnimationModifierVec2 ( int param , string param_name )
...
- *[AnimationModifierVec2](../../../../api/library/animations/timeline/class.animationmodifiervec2_usc.md)* **modifier** - Source animation modifier.
