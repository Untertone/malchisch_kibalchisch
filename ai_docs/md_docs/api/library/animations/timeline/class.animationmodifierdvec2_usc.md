# Unigine::AnimationModifierDVec2 Class (USC)
...
## AnimationModifierDVec2 ( int param )
...
## AnimationModifierDVec2 ( int param , int param_index )
...
## AnimationModifierDVec2 ( int param , string param_name )
...
## AnimationModifierDVec2 ( string param )
...
## AnimationModifierDVec2 ( string param , int param_index )
...
## AnimationModifierDVec2 ( string param , string param_name )
...
## void copy ( AnimationModifierDVec2 modifier )

Copies all data from the specified source animation modifier.
### Arguments

- *[AnimationModifierDVec2](../../../../api/library/animations/timeline/class.animationmodifierdvec2_usc.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void addValue ( float time , dvec2 value , int type = Enum.AnimationCurve.KEY_TYPE.LINEAR )

Adds the value to the modifier at the specified time.
### Arguments

- *float* **time** - Time of the key on the timeline, in seconds.
- *dvec2* **value** - The modifier value at the specified time.
