# Unigine::AnimationModifierScalar Class (CS)
...
## AnimationModifierScalar ( AnimParams.PARAM param , string param_name )
...
- *[AnimationModifierScalar](../../../../api/library/animations/timeline/class.animationmodifierscalar_cs.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void AddValue ( float time , Scalar value , AnimationCurve.KEY_TYPE type = Enum.AnimationCurve.KEY_TYPE.LINEAR )
