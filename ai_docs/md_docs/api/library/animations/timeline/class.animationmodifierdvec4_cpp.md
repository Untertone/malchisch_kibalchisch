...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierDVec4](../../../../api/library/animations/timeline/class.animationmodifierdvec4_cpp.md)> &* **modifier** - Source animation modifier.
...
- *float* **time** - Time of the key on the timeline, in seconds.
- *const  Math::[dvec4](../../../../api/library/math/class.dvec4_cpp.md) &* **value** - The modifier value at the specified time.
