# Unigine::AnimationModifierDVec3 Class (USC)
...
## AnimationModifierDVec3 ( int param )
...
## AnimationModifierDVec3 ( int param , int param_index )
...
## AnimationModifierDVec3 ( int param , string param_name )
...
- *[AnimationModifierDVec3](../../../../api/library/animations/timeline/class.animationmodifierdvec3_usc.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void addValue ( float time , dvec3 value , int type = Enum.AnimationCurve.KEY_TYPE.LINEAR )
