# Unigine::AnimationModifierFVec3 Class (USC)
...
## AnimationModifierFVec3 ( int param )
...
## AnimationModifierFVec3 ( int param , int param_index )
...
## AnimationModifierFVec3 ( int param , string param_name )
...
- *[AnimationModifierFVec3](../../../../api/library/animations/timeline/class.animationmodifierfvec3_usc.md)* **modifier** - Source animation modifier.
