# Unigine::AnimationModifierVec4 Class (CS)
...
## AnimationModifierVec4 ( AnimParams.PARAM param , string param_name )
...
- *[AnimationModifierVec4](../../../../api/library/animations/timeline/class.animationmodifiervec4_cs.md)* **modifier** - Source animation modifier.
