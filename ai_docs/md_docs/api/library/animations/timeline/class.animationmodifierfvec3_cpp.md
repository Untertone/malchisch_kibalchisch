...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierFVec3](../../../../api/library/animations/timeline/class.animationmodifierfvec3_cpp.md)> &* **modifier** - Source animation modifier.
