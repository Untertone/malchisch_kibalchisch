...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierDVec3](../../../../api/library/animations/timeline/class.animationmodifierdvec3_cpp.md)> &* **modifier** - Source animation modifier.
...
- *float* **time** - Time of the key on the timeline, in seconds.
- *const  Math::[dvec3](../../../../api/library/math/class.dvec3_cpp.md) &* **value** - The modifier value at the specified time.
