...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierIVec3](../../../../api/library/animations/timeline/class.animationmodifierivec3_cpp.md)> &* **modifier** - Source animation modifier.
...
- *float* **time** - Time of the key on the timeline, in seconds.
- *const  Math::[ivec3](../../../../api/library/math/class.ivec3_cpp.md) &* **value** - The modifier value at the specified time.
