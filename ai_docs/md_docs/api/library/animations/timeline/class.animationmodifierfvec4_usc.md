# Unigine::AnimationModifierFVec4 Class (USC)
...
## void setCurveW ( AnimationCurveFloat w )

Sets a new curve storing the values used by the modifier for the W axis.
### Arguments

- *[AnimationCurveFloat](../../../../api/library/animations/timeline/class.animationcurvefloat_usc.md)* **w** - The curve storing the values used by the modifier for the W axis.

## AnimationCurveFloat getCurveW () const
...
## AnimationModifierFVec4 ( int param )
...
## AnimationModifierFVec4 ( int param , int param_index )
...
## AnimationModifierFVec4 ( int param , string param_name )
...
## AnimationModifierFVec4 ( string param )
...
## AnimationModifierFVec4 ( string param , int param_index )
...
## AnimationModifierFVec4 ( string param , string param_name )
...
## void copy ( AnimationModifierFVec4 modifier )

Copies all data from the specified source animation modifier.
### Arguments

- *[AnimationModifierFVec4](../../../../api/library/animations/timeline/class.animationmodifierfvec4_usc.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void addValue ( float time , vec4 value , int type = Enum.AnimationCurve.KEY_TYPE.LINEAR )

Adds the value to the modifier at the specified time.
### Arguments

- *float* **time** - Time of the key on the timeline, in seconds.
- *vec4* **value** - The modifier value at the specified time.
