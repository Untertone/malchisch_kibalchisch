# Unigine::AnimationCurveDouble Class (USC)
...
- *[AnimationCurveDouble](../../../../api/library/animations/timeline/class.animationcurvedouble_usc.md)* **curve** - Source curve.
...
## int addKey ( float time , double value , int type )
...
Index of the added key point.
## int addKey ( float time , double value , int type , vec2 left_tangent , vec2 right_tangent )
