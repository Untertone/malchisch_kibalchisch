# Unigine::AnimationCurveBool Class (USC)
...
- *[AnimationCurveBool](../../../../api/library/animations/timeline/class.animationcurvebool_usc.md)* **curve** - Source curve.
...
- *int* **value** - The boolean value of the key.
