# Unigine::AnimationModifierVec4 Class (USC)
...
## void setCurveW ( AnimationCurveScalar w )

Sets a new curve storing the values used by the modifier for the W axis.
### Arguments

- *[AnimationCurveScalar](../../../../api/library/animations/timeline/class.animationcurvescalar_usc.md)* **w** - The curve storing the values used by the modifier for the W axis.

## AnimationCurveScalar getCurveW () const
...
## AnimationModifierVec4 ( int param )
...
## AnimationModifierVec4 ( int param , int param_index )
...
## AnimationModifierVec4 ( int param , string param_name )
...
## AnimationModifierVec4 ( string param )
...
## AnimationModifierVec4 ( string param , int param_index )
...
## AnimationModifierVec4 ( string param , string param_name )
...
## void copy ( AnimationModifierVec4 modifier )

Copies all data from the specified source animation modifier.
### Arguments

- *[AnimationModifierVec4](../../../../api/library/animations/timeline/class.animationmodifiervec4_usc.md)* **modifier** - Source animation modifier.
