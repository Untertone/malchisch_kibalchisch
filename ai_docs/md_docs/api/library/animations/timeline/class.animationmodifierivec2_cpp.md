...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierIVec2](../../../../api/library/animations/timeline/class.animationmodifierivec2_cpp.md)> &* **modifier** - Source animation modifier.
...
- *float* **time** - Time of the key on the timeline, in seconds.
- *const  Math::[ivec2](../../../../api/library/math/class.ivec2_cpp.md) &* **value** - The modifier value at the specified time.
