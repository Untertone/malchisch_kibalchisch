...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierVec2](../../../../api/library/animations/timeline/class.animationmodifiervec2_cpp.md)> &* **modifier** - Source animation modifier.
