# Unigine::AnimationModifierFVec2 Class (USC)
...
## AnimationModifierFVec2 ( int param )
...
## AnimationModifierFVec2 ( int param , int param_index )
...
## AnimationModifierFVec2 ( int param , string param_name )
...
- *[AnimationModifierFVec2](../../../../api/library/animations/timeline/class.animationmodifierfvec2_usc.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void addValue ( float time , vec2 value , int type = Enum.AnimationCurve.KEY_TYPE.LINEAR )
