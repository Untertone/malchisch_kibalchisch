# Unigine::AnimationCurveScalar Class (USC)
...
## scalar getDefaultKeyValue () const
...
- *[AnimationCurveScalar](../../../../api/library/animations/timeline/class.animationcurvescalar_usc.md)* **curve** - Source curve.
...
## int addKey ( float time , scalar value , int type )
...
Index of the added key point.
## int addKey ( float time , scalar value , int type , vec2 left_tangent , vec2 right_tangent )
