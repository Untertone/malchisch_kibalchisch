...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationCurveFloat](../../../../api/library/animations/timeline/class.animationcurvefloat_cpp.md)> &&* **curve** - The curve storing the values used by the modifier.
...
- *const [Ptr](../../../../api/library/common/class.ptr_cpp.md)<[AnimationModifierFloat](../../../../api/library/animations/timeline/class.animationmodifierfloat_cpp.md)> &* **modifier** - Source animation modifier.
