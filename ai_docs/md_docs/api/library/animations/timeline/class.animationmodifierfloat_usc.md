# Unigine::AnimationModifierFloat Class (USC)
...
## void setCurve ( AnimationCurveFloat curve )

Sets a new curve storing the values used by the modifier.
### Arguments

- *[AnimationCurveFloat](../../../../api/library/animations/timeline/class.animationcurvefloat_usc.md)* **curve** - The curve storing the values used by the modifier.

## AnimationCurveFloat getCurve () const
...
## AnimationModifierFloat ( int param )
...
## AnimationModifierFloat ( int param , int param_index )
...
## AnimationModifierFloat ( int param , string param_name )
...
- *[AnimationModifierFloat](../../../../api/library/animations/timeline/class.animationmodifierfloat_usc.md)* **modifier** - Source animation modifier.
...
The modifier value at the specified time.
## void addValue ( float time , float value , int type = Enum.AnimationCurve.KEY_TYPE.LINEAR )
