...
> **Notice:** Please consider our [hardware requirements](../start/requirements.md).


Below are the typical scenarios of migration to UNIGINE:


- [For *Unity* developers](../migration/from_unity/index.md)
- [For *Unreal Engine* developers](../migration/from_ue/index.md)
- For developers using [earlier UNIGINE versions](../upgrade/index.md)
