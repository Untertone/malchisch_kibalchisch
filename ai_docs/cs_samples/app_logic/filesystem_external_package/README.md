...
Package is a collection of files and data for UNIGINE projects stored in a single file. The *Package* class is a data provider for the File System. You can use it to load all necessary resources. 
