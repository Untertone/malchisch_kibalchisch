...
class ObjectMeshSkinnedLegacy;
template class UNIGINE_API EventInterfaceConnection<EventInterfaceInvoker<float, const Ptr<ObjectMeshSkinnedLegacy> &>>;
template class UNIGINE_API EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>>;
//////////////////////////////////////////////////////////////////////////

class UNIGINE_API ObjectMeshSkinnedLegacy : public Object
{
public:
	typedef const ObjectMeshSkinnedLegacy ConstObjectMeshSkinnedLegacy;

	static Node::TYPE type() { return Node::OBJECT_MESH_SKINNED_LEGACY; }
	static bool convertible(Node *node) { return (node && node->getType() == type()); }
	...
	static Ptr<ObjectMeshSkinnedLegacy> create();
	static Ptr<ObjectMeshSkinnedLegacy> create(const char *path);
	void setMeshPath(const char *path);
	const char *getMeshPath() const;
	bool isLoaded() const;
	...
	Event<float, const Ptr<ObjectMeshSkinnedLegacy> &> &getEventUpdate();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventBeginLookAtSolvers();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventEndLookAtSolvers();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventBeginIKSolvers();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventEndIKSolvers();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventBeginBoneConstraints();
	Event<const Ptr<ObjectMeshSkinnedLegacy> &> &getEventEndBoneConstraints();

private:

	EventHolder<EventInterfaceInvoker<float, const Ptr<ObjectMeshSkinnedLegacy> &>> event_update;
	EventInterfaceConnection<EventInterfaceInvoker<float, const Ptr<ObjectMeshSkinnedLegacy> &>> event_update_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_look_at_solvers;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_look_at_solvers_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_look_at_solvers;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_look_at_solvers_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_iksolvers;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_iksolvers_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_iksolvers;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_iksolvers_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_bone_constraints;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_begin_bone_constraints_connection;
	EventHolder<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_bone_constraints;
	EventInterfaceConnection<EventInterfaceInvoker<const Ptr<ObjectMeshSkinnedLegacy> &>> event_end_bone_constraints_connection;
};
typedef Ptr<ObjectMeshSkinnedLegacy> ObjectMeshSkinnedLegacyPtr;
typedef Ptr<const ObjectMeshSkinnedLegacy> ConstObjectMeshSkinnedLegacyPtr;
typedef const ObjectMeshSkinnedLegacy ConstObjectMeshSkinnedLegacy;
