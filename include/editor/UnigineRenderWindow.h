...
public:
	...
	/// <summary>Returns the handle of the native window associated with this RenderWindow.
	/// Prefer using this method over Qt's winId(), internalWinId(), and effectiveWinId() as it is the one used by the Engine.
	/// </summary>
	uint64_t getWinId() const;
