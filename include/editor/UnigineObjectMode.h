...
public:
	...
	enum GRID_MODE
	{
		...
		GRID_MODE_UNIFORM,
		/// <summary>Node positioning is performed by moving over the grid defined by mesh vertices.</summary>
		GRID_MODE_VERTEX,
	...
	// Manipulators
	/// <summary>Sets the value indicating if the manipulators are enabled.</summary>
	...
	/// <summary>Sets the value indicating if X-ray mode for vertex snapping is enabled. When enabled, vertices obscured by other geometry are taken into account during snapping; otherwise, they are ignored.</summary>
	/// <param name='enabled'>Value indicating if X-ray mode for vertex snapping is enabled.</param>
	static void setPositionSnappingByVertexXrayEnabled(bool enabled);
	/// <summary>Returns the value indicating if X-ray mode for vertex snapping is enabled. When enabled, vertices obscured by other geometry are taken into account during snapping; otherwise, they are ignored.</summary>
	static bool isPositionSnappingByVertexXrayEnabled();
	/// <summary>Sets the maximum distance for vertex snapping. If the distance from the camera to a vertex exceeds this value, the vertex will be ignored during snapping.</summary>
	/// <param name='distance'>Maximum distance from the camera for vertex snapping, in units.</param>
	static void setPositionSnappingByVertexDistance(float distance);
	/// <summary>Returns the maximum distance for vertex snapping. If the distance from the camera to a vertex exceeds this value, the vertex will be ignored during snapping.</summary>
	static float getPositionSnappingByVertexDistance();
	// Snap to Surface
