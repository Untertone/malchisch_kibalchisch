...
public:
	...
	enum PARAM
	{
		...
		PARAM_OBJECT_MESH_SKINNED_LEGACY__ANIM_PATH, // object_mesh_skinned_legacy.anim_path String
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BIND_BONE_SPACE_INDEXED, // object_mesh_skinned_legacy.bind_bone_space_indexed Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BIND_MODE_INDEXED, // object_mesh_skinned_legacy.bind_mode_indexed Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BIND_NODE_INDEXED, // object_mesh_skinned_legacy.bind_node_indexed Node
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BIND_NODE_OFFSET_INDEXED, // object_mesh_skinned_legacy.bind_node_offset_indexed Mat4
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BIND_NODE_SPACE_INDEXED, // object_mesh_skinned_legacy.bind_node_space_indexed Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__BONE_WORLD_TRANSFORM_INDEXED, // object_mesh_skinned_legacy.bone_world_transform_indexed Mat4
		PARAM_OBJECT_MESH_SKINNED_LEGACY__CONTROLLED, // object_mesh_skinned_legacy.controlled Bool
		PARAM_OBJECT_MESH_SKINNED_LEGACY__FPS_INVISIBLE, // object_mesh_skinned_legacy.fps_invisible Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__FPS_VISIBLE_CAMERA, // object_mesh_skinned_legacy.fps_visible_camera Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__FPS_VISIBLE_SHADOW, // object_mesh_skinned_legacy.fps_visible_shadow Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__IK_CHAIN_NUM_ITERATIONS_INDEXED, // object_mesh_skinned_legacy.ik_chain_num_iterations_indexed Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__INTERPOLATION_ACCURACY, // object_mesh_skinned_legacy.interpolation_accuracy Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__LAYER_ANIMATION_FILE_PATH_INDEXED, // object_mesh_skinned_legacy.layer_animation_file_path_indexed String
		PARAM_OBJECT_MESH_SKINNED_LEGACY__LAYER_WEIGHT_INDEXED, // object_mesh_skinned_legacy.layer_weight_indexed Float
		PARAM_OBJECT_MESH_SKINNED_LEGACY__LOOP, // object_mesh_skinned_legacy.loop Bool
		PARAM_OBJECT_MESH_SKINNED_LEGACY__MESH_PATH, // object_mesh_skinned_legacy.mesh_path String
		PARAM_OBJECT_MESH_SKINNED_LEGACY__MESH_PROCEDURAL_MODE, // object_mesh_skinned_legacy.mesh_procedural_mode Bool
		PARAM_OBJECT_MESH_SKINNED_LEGACY__NUM_LAYERS, // object_mesh_skinned_legacy.num_layers Int
		PARAM_OBJECT_MESH_SKINNED_LEGACY__PLAYING, // object_mesh_skinned_legacy.playing Bool
		PARAM_OBJECT_MESH_SKINNED_LEGACY__QUATERNION, // object_mesh_skinned_legacy.quaternion Bool
		PARAM_OBJECT_MESH_SKINNED_LEGACY__SPEED, // object_mesh_skinned_legacy.speed Float
		PARAM_OBJECT_MESH_SKINNED_LEGACY__TIME, // object_mesh_skinned_legacy.time Float
		PARAM_OBJECT_MESH_SKINNED_LEGACY__UPDATE_DISTANCE_LIMIT, // object_mesh_skinned_legacy.update_distance_limit Float
		PARAM_OBJECT_MESH_SKINNED_LEGACY__VISUALIZE_ALL_BONES, // object_mesh_skinned_legacy.visualize_all_bones Bool
		...
		PARAM_RENDER__CLOUDS_ENVIRONMENT_COLOR, // render.clouds_environment_color FVec4
		PARAM_RENDER__CLOUDS_ENVIRONMENT_COLOR_W, // render.clouds_environment_color_w Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_COLOR_X, // render.clouds_environment_color_x Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_COLOR_Y, // render.clouds_environment_color_y Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_COLOR_Z, // render.clouds_environment_color_z Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY, // render.clouds_environment_sky Bool
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY_COLOR, // render.clouds_environment_sky_color FVec4
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY_COLOR_W, // render.clouds_environment_sky_color_w Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY_COLOR_X, // render.clouds_environment_sky_color_x Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY_COLOR_Y, // render.clouds_environment_sky_color_y Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_SKY_COLOR_Z, // render.clouds_environment_sky_color_z Float
		PARAM_RENDER__CLOUDS_ENVIRONMENT_TEXTURE_PATH, // render.clouds_environment_texture_path String
		...
		PARAM_RENDER__DLSS_RESOLUTION_SCALE_ENABLED, // render.dlss_resolution_scale_enabled Bool
		PARAM_RENDER__DLSS_RESOLUTION_SCALE_VALUE, // render.dlss_resolution_scale_value Float
		...
		PARAM_RENDER__ENVIRONMENT_DITHER_SCALE, // render.environment_dither_scale Float
		...
		PARAM_RENDER__ENVIRONMENT_HAZE_DITHER_SCALE, // render.environment_haze_dither_scale Float
		...
		PARAM_RENDER__ENVIRONMENT_HAZE_RESOLUTION, // render.environment_haze_resolution Int
		...
		PARAM_RENDER__FSR_CUSTOM_RESOLUTION_SCALE, // render.fsr_custom_resolution_scale Float
		...
		PARAM_RENDER__FSR_SHOW_DEBUG_VIEW, // render.fsr_show_debug_view Bool
		...
		PARAM_RENDER__LIGHTS_DITHER_SCALE, // render.lights_dither_scale Float
		...
		PARAM_RENDER__OCCLUDER_DISTANCE, // render.occluder_distance Float
		...
		PARAM_RENDER__PARAMETER_BOOL_INDEXED, // render.parameter_bool_indexed Bool
		PARAM_RENDER__PARAMETER_BOOL_NAMED, // render.parameter_bool_named Bool
		PARAM_RENDER__PARAMETER_FLOAT_INDEXED, // render.parameter_float_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT_NAMED, // render.parameter_float_named Float
		PARAM_RENDER__PARAMETER_FLOAT2_INDEXED, // render.parameter_float2_indexed FVec2
		PARAM_RENDER__PARAMETER_FLOAT2_NAMED, // render.parameter_float2_named FVec2
		PARAM_RENDER__PARAMETER_FLOAT2_X_INDEXED, // render.parameter_float2_x_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT2_X_NAMED, // render.parameter_float2_x_named Float
		PARAM_RENDER__PARAMETER_FLOAT2_Y_INDEXED, // render.parameter_float2_y_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT2_Y_NAMED, // render.parameter_float2_y_named Float
		PARAM_RENDER__PARAMETER_FLOAT3_INDEXED, // render.parameter_float3_indexed FVec3
		PARAM_RENDER__PARAMETER_FLOAT3_NAMED, // render.parameter_float3_named FVec3
		PARAM_RENDER__PARAMETER_FLOAT3_X_INDEXED, // render.parameter_float3_x_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT3_X_NAMED, // render.parameter_float3_x_named Float
		PARAM_RENDER__PARAMETER_FLOAT3_Y_INDEXED, // render.parameter_float3_y_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT3_Y_NAMED, // render.parameter_float3_y_named Float
		PARAM_RENDER__PARAMETER_FLOAT3_Z_INDEXED, // render.parameter_float3_z_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT3_Z_NAMED, // render.parameter_float3_z_named Float
		PARAM_RENDER__PARAMETER_FLOAT4_INDEXED, // render.parameter_float4_indexed FVec4
		PARAM_RENDER__PARAMETER_FLOAT4_NAMED, // render.parameter_float4_named FVec4
		PARAM_RENDER__PARAMETER_FLOAT4_W_INDEXED, // render.parameter_float4_w_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT4_W_NAMED, // render.parameter_float4_w_named Float
		PARAM_RENDER__PARAMETER_FLOAT4_X_INDEXED, // render.parameter_float4_x_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT4_X_NAMED, // render.parameter_float4_x_named Float
		PARAM_RENDER__PARAMETER_FLOAT4_Y_INDEXED, // render.parameter_float4_y_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT4_Y_NAMED, // render.parameter_float4_y_named Float
		PARAM_RENDER__PARAMETER_FLOAT4_Z_INDEXED, // render.parameter_float4_z_indexed Float
		PARAM_RENDER__PARAMETER_FLOAT4_Z_NAMED, // render.parameter_float4_z_named Float
		PARAM_RENDER__PARAMETER_INT_INDEXED, // render.parameter_int_indexed Int
		PARAM_RENDER__PARAMETER_INT_NAMED, // render.parameter_int_named Int
		PARAM_RENDER__PARAMETER_INT2_INDEXED, // render.parameter_int2_indexed IVec2
		PARAM_RENDER__PARAMETER_INT2_NAMED, // render.parameter_int2_named IVec2
		PARAM_RENDER__PARAMETER_INT2_X_INDEXED, // render.parameter_int2_x_indexed Int
		PARAM_RENDER__PARAMETER_INT2_X_NAMED, // render.parameter_int2_x_named Int
		PARAM_RENDER__PARAMETER_INT2_Y_INDEXED, // render.parameter_int2_y_indexed Int
		PARAM_RENDER__PARAMETER_INT2_Y_NAMED, // render.parameter_int2_y_named Int
		PARAM_RENDER__PARAMETER_INT3_INDEXED, // render.parameter_int3_indexed IVec3
		PARAM_RENDER__PARAMETER_INT3_NAMED, // render.parameter_int3_named IVec3
		PARAM_RENDER__PARAMETER_INT3_X_INDEXED, // render.parameter_int3_x_indexed Int
		PARAM_RENDER__PARAMETER_INT3_X_NAMED, // render.parameter_int3_x_named Int
		PARAM_RENDER__PARAMETER_INT3_Y_INDEXED, // render.parameter_int3_y_indexed Int
		PARAM_RENDER__PARAMETER_INT3_Y_NAMED, // render.parameter_int3_y_named Int
		PARAM_RENDER__PARAMETER_INT3_Z_INDEXED, // render.parameter_int3_z_indexed Int
		PARAM_RENDER__PARAMETER_INT3_Z_NAMED, // render.parameter_int3_z_named Int
		PARAM_RENDER__PARAMETER_INT4_INDEXED, // render.parameter_int4_indexed IVec4
		PARAM_RENDER__PARAMETER_INT4_NAMED, // render.parameter_int4_named IVec4
		PARAM_RENDER__PARAMETER_INT4_W_INDEXED, // render.parameter_int4_w_indexed Int
		PARAM_RENDER__PARAMETER_INT4_W_NAMED, // render.parameter_int4_w_named Int
		PARAM_RENDER__PARAMETER_INT4_X_INDEXED, // render.parameter_int4_x_indexed Int
		PARAM_RENDER__PARAMETER_INT4_X_NAMED, // render.parameter_int4_x_named Int
		PARAM_RENDER__PARAMETER_INT4_Y_INDEXED, // render.parameter_int4_y_indexed Int
		PARAM_RENDER__PARAMETER_INT4_Y_NAMED, // render.parameter_int4_y_named Int
		PARAM_RENDER__PARAMETER_INT4_Z_INDEXED, // render.parameter_int4_z_indexed Int
		PARAM_RENDER__PARAMETER_INT4_Z_NAMED, // render.parameter_int4_z_named Int
		PARAM_RENDER__PARAMETER_NAME_INDEXED, // render.parameter_name_indexed String
		PARAM_RENDER__PARAMETER_TYPE_INDEXED, // render.parameter_type_indexed Int
		...
		PARAM_RENDER__SHADING_QUALITY, // render.shading_quality Int
		...
		PARAM_RENDER__SHARPEN_RESOLUTION, // render.sharpen_resolution Int
		...
		PARAM_RENDER__SHOW_DEPTH_PRE_PASS, // render.show_depth_pre_pass Bool
		...
		PARAM_RENDER__SHOW_PROJ_AND_OMNI_SHADOW_CASTERS, // render.show_proj_and_omni_shadow_casters Bool
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_BLEND, // render.show_quad_overdraw_blend Float
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_DISPLAY_MODE, // render.show_quad_overdraw_display_mode Int
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_ENABLED, // render.show_quad_overdraw_enabled Bool
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_LANDSCAPE_TERRAIN, // render.show_quad_overdraw_landscape_terrain Bool
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_PASSES, // render.show_quad_overdraw_passes Int
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_THRESHOLD, // render.show_quad_overdraw_threshold Int
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_WATER_GLOBAL, // render.show_quad_overdraw_water_global Bool
		PARAM_RENDER__SHOW_QUAD_OVERDRAW_WIREFRAME, // render.show_quad_overdraw_wireframe Bool
		...
		PARAM_RENDER__SHOW_TRANSPARENT_G_BUFFER, // render.show_transparent_g_buffer Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_AMBIENT, // render.show_transparent_lighting_ambient Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_ENVIRONMENT_PROBE, // render.show_transparent_lighting_environment_probe Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_LIGHT_OMNI, // render.show_transparent_lighting_light_omni Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_LIGHT_PROJ, // render.show_transparent_lighting_light_proj Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_LIGHT_WORLD, // render.show_transparent_lighting_light_world Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_PLANAR_PROBE, // render.show_transparent_lighting_planar_probe Bool
		PARAM_RENDER__SHOW_TRANSPARENT_LIGHTING_VOXEL_PROBE, // render.show_transparent_lighting_voxel_probe Bool
		PARAM_RENDER__SHOW_TRIANGLES, // render.show_triangles Int
		PARAM_RENDER__SHOW_VERTEX_COLOR, // render.show_vertex_color Int
		PARAM_RENDER__SHOW_VERTEX_DENSITY_BLEND, // render.show_vertex_density_blend Float
		PARAM_RENDER__SHOW_VERTEX_DENSITY_DEPTH_TEST, // render.show_vertex_density_depth_test Bool
		PARAM_RENDER__SHOW_VERTEX_DENSITY_ENABLED, // render.show_vertex_density_enabled Bool
		PARAM_RENDER__SHOW_VERTEX_DENSITY_MODE, // render.show_vertex_density_mode Int
		PARAM_RENDER__SHOW_VERTEX_DENSITY_SEARCH_AREA, // render.show_vertex_density_search_area Int
		PARAM_RENDER__SHOW_VERTEX_DENSITY_THRESHOLD, // render.show_vertex_density_threshold Int
		...
		PARAM_RENDER__STREAMING_FREE_SPACE_RAM_COMMITTED, // render.streaming_free_space_ram_committed Int
		PARAM_RENDER__STREAMING_FREE_SPACE_VRAM, // render.streaming_free_space_vram Int
		PARAM_RENDER__STREAMING_I_GPU_VRAM_BALANCE, // render.streaming_i_gpu_vram_balance Int
		PARAM_RENDER__STREAMING_I_GPU_VRAM_MODE, // render.streaming_i_gpu_vram_mode Int
		PARAM_RENDER__STREAMING_I_GPU_VRAM_SIZE, // render.streaming_i_gpu_vram_size Int
		...
		PARAM_RENDER__UPSCALE_FIX_FLICKER, // render.upscale_fix_flicker Bool
		PARAM_RENDER__UPSCALE_MODE, // render.upscale_mode Int
		PARAM_RENDER__UPSCALE_ORDER, // render.upscale_order Int
		...
		PARAM_RENDER_STATE__CONSERVATIVE_RASTERIZATION_ENABLED, // render_state.conservative_rasterization_enabled Bool
		PARAM_RENDER_STATE__DEPTH_FUNC, // render_state.depth_func Int
		PARAM_RENDER_STATE__DEPTH_WRITE, // render_state.depth_write Bool
		...
		// WorldTransformJoint
		PARAM_WORLD_TRANSFORM_JOINT__JOINT_NAME, // world_transform_joint.joint_name String
