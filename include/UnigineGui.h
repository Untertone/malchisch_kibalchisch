...
public:
	...
	static void setGlobalFontFallback(const Vector<String> &fallbacks);
	static void getGlobalFontFallback(Vector<String> &ret);
	static void setFontFallback(const char *font, const Vector<String> &fallbacks);
	static void getFontFallback(const char *font, Vector<String> &ret);
};
