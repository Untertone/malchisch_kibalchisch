...
public:
	...
	union
	{
		PROGRAMMER_SOUND_PROPERTIES		programmer_sound_properties;
		PLUGIN_INSTANCE_PROPERTIES		plugin_instance_properties;
		TIMELINE_MARKER_PROPERTIES		timeline_marker_properties;
		TIMELINE_BEAT_PROPERTIES		timeline_beat_properties;
		TIMELINE_NESTED_BEAT_PROPERTIES timeline_nested_beat_properties;
		void							*fmod_sound_ov_event;
	};

	};

	typedef FMODEnums::ERROR_TYPE (FMOD_CALL *EVENT_CALLBACK)(FMODEnums::EVENT_CALLBACK_TYPE type, void *fmod_event, CALLBACK_PARAMETERS *parameters);
};
...
public:
	...
	virtual void getUserData(void **user_data) const = 0;
	virtual FMODEnums::ERROR_TYPE setCallback(FMODStructs::EVENT_CALLBACK, unsigned int callback_mask) = 0;
...
public:
	...
	virtual bool getEventUserData(void *fmod_event, void **user_data) const = 0;
